...
public class GlobalException {
    ...
    public ResponseEntity<String> handleListarExcessao(ExcecoesPersonalizadas.ListarExcessao e) {
        // Tratar a exceção, logar, etc.
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Erro ao listar Pessoas: "+ e);
    }
    ...
    public ResponseEntity<String> handleListarExcessao(ExcecoesPersonalizadas.BuscarPessoaExcessao e) {
        // Tratar a exceção, logar, etc.
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Erro ao buscar pessoa Específica: "+ e);
    }
    ...
    public ResponseEntity<String> handleListarExcessao(ExcecoesPersonalizadas.CriarPessoaExcessao e) {
        // Tratar a exceção, logar, etc.
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Erro ao criar usuário, verifique os dados!: "+ e);
    }
    ...
    public ResponseEntity<String> handleListarExcessao(ExcecoesPersonalizadas.AtualizarPessoaExcessao e) {
        // Tratar a exceção, logar, etc.
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Erro ao atualizar usuário, verifique os dados!: "+ e);
    }
